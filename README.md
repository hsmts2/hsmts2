...
| [aws-nfw-policy-switch-poc](https://github.com/hsmts2/aws-nfw-policy-switch-poc) | Patch Managerのメンテナンス時間に合わせたNetwork Firewallポリシー切り替えPoC | AWS Network Firewall、Lambda、EventBridge Scheduler、Patch Manager、CloudFormation |
| [aws-backup-ops-baseline-poc](https://github.com/hsmts2/aws-backup-ops-baseline-poc) | AWS Backupを利用したタグベースのバックアップ運用基盤PoC | AWS Backup、Backup Vault、EventBridge、SNS、KMS、CloudFormation |
